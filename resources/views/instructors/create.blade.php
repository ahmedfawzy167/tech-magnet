...
<div class="card">
 <div class="card-body">
   <h1 class="text-center bg-primary text-white"><i class="ion-plus-circled"></i> {{__('admin.Add New Instructor')}}</h1>
   <form action="{{ route('instructors.store') }}" method="POST" class="row">
    @csrf
